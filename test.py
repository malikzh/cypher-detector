...
FILE = 'DES.txt' # Change file for testing

model = CypherDetectorSimpleModel(3) # IMPORTANT: 3 classes
...
print(f'Total accuracy: {correct / total * 100.0:2f} Correct items: {correct} / Total items: {total}')